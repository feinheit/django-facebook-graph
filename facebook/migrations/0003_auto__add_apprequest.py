...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Apprequest'
        db.create_table('facebook_apprequest', (
            ...
            ('_from', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='apprequest_from_set', null=True, to=orm['facebook.User'])),
        ...
        db.send_create_signal('facebook', ['Apprequest'])

        # Adding M2M table for field _to on 'Apprequest'
        db.create_table('facebook_apprequest__to', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('apprequest', models.ForeignKey(orm['facebook.apprequest'], null=False)),
            ('user', models.ForeignKey(orm['facebook.user'], null=False))
        ))
        db.create_unique('facebook_apprequest__to', ['apprequest_id', 'user_id'])

    def backwards(self, orm):
        # Deleting model 'Apprequest'
        db.delete_table('facebook_apprequest')

        # Removing M2M table for field _to on 'Apprequest'
        db.delete_table('facebook_apprequest__to')
    ...
    models = {
        ...
        'facebook.apprequest': {
            ...
            '_from': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'apprequest_from_set'", 'null': 'True', 'to': "orm['facebook.User']"}),
            '_graph': ('facebook.fields.JSONField', [], {'null': 'True', 'blank': 'True'}),
            '_message': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            '_to': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['facebook.User']", 'null': 'True', 'blank': 'True'}),
