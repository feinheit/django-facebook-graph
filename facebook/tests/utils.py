...
class UtilsTestCase(DatabaseSessionTests):
    ...
    def test_settings(self):
        ...
        self.assertEqual(fb['API-KEY'], '35992623dc137df952677f666610948a')
        self.assertEqual(fb['SECRET'], 'd4ba1920446f44d557fc6518c475d9b7')
        self.assertEqual(fb['CANVAS-PAGE'], 'http://apps.facebook.com/fh-unittest/')
        self.assertEqual(fb['CANVAS-URL'], 'http://localhost.local:8000/')
        self.assertEqual(fb['SECURE-CANVAS-URL'], 'https://localhost.local/')
        self.assertEqual(fb['REDIRECT-URL'], 'http://apps.facebook.com/fh-unittest/')
    ...
    def test_get_graph(self):
        ...
        self.assertTrue(isinstance(graph.get_token_from_session(), basestring))
